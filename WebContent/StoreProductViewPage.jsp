...
<div class="wrapper">
	...
	<%
		if(session.getAttribute("storeStaff") != null){
			/* StoreStaff ss = (StoreStaff)session.getAttribute("storeStaff");
			out.println("SID : "+ss.getSid()+"<br>");
			out.println("DC id : "+ss.getDcid()+"<br>"); */
	...
	%>
    	...
    	<caption><h1>Store Product Details</h1></caption>
