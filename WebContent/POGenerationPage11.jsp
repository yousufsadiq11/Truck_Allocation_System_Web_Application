...
<body>
	...
	%></div></b>
				<form action="POStaffController" method="post">
				<div class="form-group">
						<label class="control-label col-sm-2" for="PO Id">DC Id</label>
						<div class="col-sm-10">

							<input type="text" class="form-control" value=<%= request.getAttribute("dcid") %>
								name="dcid" readonly>
						</div>
					</div>
		...
		%>
				...
				for(Product temp:pobj){ %>
					...
					<input type="hidden" name="action" value="addDCPO">
