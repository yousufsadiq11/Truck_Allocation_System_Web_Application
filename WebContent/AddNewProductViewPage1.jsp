	...
	<div class="wrapper">
		...
		<div class="head3">
			...
			<div class="cd2">
				...
				<br>
				<h4 align="center" style="color: #2222B5;">Enter Product Detail</h4>
				<br> <br>
				<b><div style="color:green;">
				<%if(request.getAttribute("msg") != null){ 
			out.println(request.getAttribute("msg").toString());
		}
	 	ArrayList<Product> obj = (ArrayList<Product>)request.getAttribute("products");
		if(obj.size() > 0){	%></div></b>
				<form name="sform" action="DCController" method="get"
					...
					<input type="hidden" name="action" value="addDCProduct">
				</form>
				<%}else{ %>
