<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
       <%@ page import="java.util.ArrayList,bean.Vendor" %>
...
<div class="wrapper">
		...
		<div class="head1">
			...
			<div class="f1">
				...
				<h2>All Vendors of Unit Head</h2>	
				
	<% ArrayList<Vendor> dc=(ArrayList<Vendor>)request.getAttribute("Vendors"); %>
<% if (dc.size()>0){%>
					
					
					
						<table class="table table-striped" align="center">
						<caption><h1>Vendor Details</h1></caption>
