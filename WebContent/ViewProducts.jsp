<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="java.util.ArrayList,bean.UnitHeadProduct" %>
...
<div class="wrapper">
	...
	<% ArrayList<UnitHeadProduct> dc=(ArrayList<UnitHeadProduct>)request.getAttribute("Products"); %>
<% if (dc.size()>0){%>
    ...
    <% for(UnitHeadProduct dcd:dc){ %>
			<tr>
			    <td><%=dcd.getpId() %></td>
			    <td><%=dcd.getpName() %></td>
			    <td><%=dcd.getpDetail() %></td>
			</tr>
           <%} %>
		</table>
	<%
