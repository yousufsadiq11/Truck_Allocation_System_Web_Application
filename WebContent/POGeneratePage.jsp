	...
	<div class="wrapper">
		...
		<div class="head3">
			...
			<div class="cd1">
				...
				<br></br> <br>
				<h3>[CLick below links to navigate]</h3>
				<br> <br>
	<div >	<a href="AddDC.jsp"style="color:white;">Create New DC </a><br></div><br><br><br>
		<div><a href="AddStore.jsp"style="color:white;">Add New Store</a><br></div><br><br><br>
		<div><a href="DCController?action=addNewProduct"style="color:white;">Add New Product</a><br></div><br><br><br>
		<div><a href="DCController?action=updateProductDetail"style="color:white;">Update Product Detail</a><br></div><br><br><br>
		<div><a href="DCController?action=viewStore"style="color:white;">View DC's Store</a><br></div><br><br><br>
		<div><a href="DCController?action=showProduct"style="color:white;">View Product</a><br></div><br><br><br>
		<div><a href="DCController?action=showThProduct"style="color:white;">Show Th Product</a><br></div><br><br><br>
		<div><a href="DCController?action=poGenerate"style="color:white;">Purchase order generate</a><br></div><br><br><br>
		<div><a href="DCController?action=storeApprovedPOs"style="color:white;">Store Approved POs</a><br></div><br><br><br>
		<div><a href="DCController?action=storeGeneratedPOs"style="color:white;">Store Generated POs</a><br></div><br><br><br>
		<div><a href ="DCController?action=DeleteDCStorePage"style="color:white;">Delete Store</a><br></div><br><br><br>
		<div><a href ="DCController?action=Update"style="color:white;">Update DC Store</a><br></div><br><br><br>
			</div>
			<div class="g1"></div>
			<div class="cd2">
