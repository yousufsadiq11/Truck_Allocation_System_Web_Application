...
if(session.getAttribute("msg") != null){
	...
	session.removeAttribute("msg");
				...
				<% ArrayList<PurchaseOrder> poa2=(ArrayList<PurchaseOrder>)session.getAttribute("POs"); %>
					<% if (poa2.size()>0){%>
						...
						<table class="table table-striped" align="center"><caption><h1>Newly generated PO Details</h1></caption>
    ...
    <% for(PurchaseOrder po3:poa2){
			...
			<tr>
			    ...
			    <td><a href="aaa?action=approvePO&poid=<%=po3.getPoId() %>">Approve PO</a></td>
			</tr>
           <%} 
           }%>
		</table>
