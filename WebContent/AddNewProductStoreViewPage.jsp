...
<script type="text/javascript" src="js/validatestoreproductview.js"></script>
	...
	<div class="wrapper">
		...
		<div class="head3">
			...
			<div class="cd2">
				...
				<form name="viewform" action="StoreController" method="get"
					...
					<input type="hidden" name="action" value="addStoreProduct">
